...
import { fastMovers as allFastMovers } from '../../data/mockInventory.js';
...
export default function FastMovers() {
  ...
  // Safe defaults
  const fastMovers = Array.isArray(allFastMovers) ? allFastMovers : [];

  const filtered = useMemo(() => {
    return fastMovers.filter((r) =>
      search === '' ||
  ...
  const columns = [
    { key: 'sku', label: 'SKU' },
    { key: 'name', label: 'Name' },
    { key: 'issues30', label: 'Issues (30d)' },
    { key: 'issues90', label: 'Issues (90d)' },
    { key: 'avgPerDay30', label: 'Avg/Day (30d)' },
    { key: 'lastIssued', label: 'Last Issued' },
  ...
  return (
    <div className="space-y-4">
      ...
      <EditModal open={!!editing} onClose={() => setEditing(null)} row={editing} title="Edit Fast Mover" />
